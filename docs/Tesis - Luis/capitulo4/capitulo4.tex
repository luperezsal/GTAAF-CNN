...
\begin{figure}[H]
	\centering    
	\subfloat[Ejemplo de muestras de accidentes originales]{\includegraphics[width=7cm]{Figures/areas-points.png}}
	\subfloat[Ejemplo de muestras de accidentes filtradas]{\includegraphics[width=7cm]{Figures/areas-points-filtered.png}}
