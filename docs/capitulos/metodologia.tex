...
\section{Fases}
    ...
    \subsection{Matrices}
        ...
        \textbf{NOTA: Poner por qué se posicioinan así, porque los filtros 3x3 pasan más veces.....}

        Un ejemplo de la construcción de estas matrices se ve reflejado en la figura \cite{FV2IExampleImage}.
