...
\section{Proceso}
    ...
    \begin{enumerate}
            ...
            \begin{enumerate}
                ...
                \item Análisis de datos
                    ...
                    \begin{figure}[H]
                     ...
                     Analizando la matriz de correlación \ref{CorrelationMatrixImage} se puede observar que la variable \textit{coordenada_x_utm} y la variable \textit {distrito} están relativamente correlacionadas. Por lo que 
        ...
        \item XGBoost
            ...
            Una vez se han optimizados los hiperparámetros del \glsentryshort{xgboost}, se calcula la importancia de cada clase mediante el cálculo de los pesos. \cite{XGBoostFeatureWeightsMeaning}
