...
for n_param in range(numberOfParameters):
    hyperparam_to_optimize = HYPERPARAMS_TO_OPTIMIZE[n_param]
    best_hyperparams[hyperparam_to_optimize] = population[bestFitnessIndex][n_param]
